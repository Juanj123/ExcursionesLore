<%@ Page Title="" Language="C#" MasterPageFile="~/HomeAdministrator.Master" AutoEventWireup="true" CodeBehind="Imagen.aspx.cs" Inherits="ExcursionesLorePantoja.Imagen" ClientIDMode="Static" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xl-12">
                <h2>Imagenes</h2>
                <br />
                <asp:Button runat="server" ID="btnAgregarImg" CssClass="btn btn-success" Text="Agregar Imagen" OnClick="btnAgregarImg_Click" />
                <br />
                <br />
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle">Actualizar Imagen</h5>
